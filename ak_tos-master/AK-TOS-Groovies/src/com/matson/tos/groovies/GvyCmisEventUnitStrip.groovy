...
public class GvyCmisEventUnitStrip
{
    ...
    private static final Logger stripLogger = Logger.getLogger(GvyCmisEventUnitStrip.class);


    public void stripUnit(Object event)
    {
        def gvyStripXml = ''
        stripLogger.setLevel(Level.INFO);
        stripLogger.info(" GvyCmisEventUnitStrip execute Stared.");
        try
        {
            ...
            e.printStackTrace();
            stripLogger.info(" Error occured in stripUnit method."+e.getMessage());
        }
    }
    ...
    public String getMTXMessage(Object unit, String eventNotes, Object gvyEventObj, String inGvyStripXml) {
        ...
        try {
            ...
            ex.printStackTrace();
            stripLogger.info(" Error occured in getMTXMessage method."+e.getMessage());
        }
        return null;
    }
    ...
    public String processUnitStrip(Object unit, String eventNotes, Object gvyEventObj)
    {
        ...
        try
        {
            ...
            stripLogger.info('Strip facility-->'+facility);

            def facilityAttr = gvyTxtMsgFmt.doIt('facility', facility)

            stripLogger.info('facilityAttr-->'+facilityAttr);
            ...
            //Passing List
            def stripAttributes = ' '+actionAttributes+legAttr+typeCodeAttr+hgtAttr+commodityAttr

            groovyXml = gvyTxtMsgFmt.createGroovyXml(stripAttributes)

        }catch(Exception e){
            e.printStackTrace();
            stripLogger.info(" Error occured in processUnitStrip method."+e.getMessage());
        }
        return groovyXml
    }//Method Ends
