    ...
    public void execute(TransactionAndVisitHolder inOutDao) {
        ...
        if (RoadBizUtil.getMessageCollector().hasError() || !inOutDao.hasTransaction()) {
            if (RoadBizUtil.getMessageCollector().hasError()) {
                LOGGER.error("Errors in the Transaction SEVERE : " + RoadBizUtil.getMessageCollector().getMessageCount(com.navis.framework.util.message.MessageLevel.SEVERE));
                ...
                for (BizFailure bizFailure : RoadBizUtil.getMessageCollector().getMessages()) {
                    LOGGER.error(bizFailure.toString());
                }
            }
