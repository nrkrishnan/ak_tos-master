...
Steps:
    ...
    Add Notice to call the plug-in
        ...
        3. Enter the values as below:
            ...
            Action:             Execute Code
            (Code):             def rpValidator = api.getGroovyClassInstance("MaherGvyBookingPreadviseValidationForLoad")
...
public class MaherGvyBookingPreadviseValidationForLoad {
    ...
    public void execute(Object event, Object api)
    {
        ...
        try {
            ...
            // Booking validations need to be done only for containers with containerStatus is FCL, LCL
            ...
            try {
                ...
                println("Exception occured in MaherGvyBookingPreadviseValidationForLoad.groovy" + inEx);
