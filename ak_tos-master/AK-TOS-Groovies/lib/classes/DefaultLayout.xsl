...
<xsl:stylesheet version="1.1" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format"
    ...
    <xsl:template match="/">
        <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
            <fo:layout-master-set>
                <fo:simple-page-master master-name="simpleA4" page-height="11.5in" page-width="8.5in" margin-top="1in" margin-bottom="1in"
            ...
            <fo:page-sequence master-reference="simpleA4">
                <fo:flow flow-name="xsl-region-body">
                    <fo:block font-size="10pt" font-weight="bold" space-after="10mm">
                    </fo:block>
    ...
    <xsl:template match="argo:truckVisit">
        <fo:table-row>
            <fo:table-cell>
                <fo:block font-size="10pt">Default Ticket Format</fo:block>
            </fo:table-cell>
            <fo:table-cell>
                <fo:block font-size="10pt">- Gate Pass</fo:block>
            </fo:table-cell>
            <fo:table-cell>
