...
public class CYHONContainerReportGenerator implements JRDataSource{

	ArrayList<TosStowPlanCntrMt> jrMtyCtrDetail = new ArrayList<TosStowPlanCntrMt>();

	int index = -1;

	public CYHONContainerReportGenerator(String Vesvoy) {

		List<?> mtyCtrList = NewReportVesselDao.getCYHonContainerReportGeneratorList(Vesvoy);
