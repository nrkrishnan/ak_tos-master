...
public class EBSITReportGenerator implements JRDataSource{

	ArrayList<TosStowPlanCntrMt> jrMtyCtrDetail = new ArrayList<TosStowPlanCntrMt>();

	int index = -1;

	public EBSITReportGenerator(String Vesvoy) {

		List<?> mtyCtrList = NewReportVesselDao.getEBSITReportGeneratorList(Vesvoy);
