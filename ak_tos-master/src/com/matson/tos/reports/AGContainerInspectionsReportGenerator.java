 ...
 *  A4		04/11/2013		Karthik Rajendran		Commented: getAGContainerInspectionsList2()
 *  
 */

public class AGContainerInspectionsReportGenerator implements JRDataSource{

	ArrayList<TosRdsDataFinalMt> jrAgCtrInspecDetail = new ArrayList<TosRdsDataFinalMt>();

	int index = -1;

	public AGContainerInspectionsReportGenerator(String Vesvoy) {
		...
		if ((agCtrInspList1 == null) || ( agCtrInspList1.size() >= 0)) {
			for (int i = 0; i < agCtrInspList1.size(); i++) {
				...
				jrTosRdsFinalData.setCargoNotes(((TosRdsDataFinalMt)agCtrInspList1.get(i)).getCargoNotes());
				...
				jrTosRdsFinalData.setCrstatus(((TosRdsDataFinalMt)agCtrInspList1.get(i)).getCrstatus());
