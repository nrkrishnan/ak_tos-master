...
insert into TOSCSTMMGR.TOS_APP_PARAMETER ( KEY, VALUE) values ( 'VES_FILES_FTP_ID', '501');
insert into TOSCSTMMGR.TOS_APP_PARAMETER ( KEY, VALUE) values ( 'DCM_IN_FTP_ID', '503');
insert into TOSCSTMMGR.TOS_APP_PARAMETER ( KEY, VALUE) values ( 'DCM_OUT_FTP_ID', '504');
insert into TOSCSTMMGR.TOS_APP_PARAMETER ( KEY, VALUE) values ( 'FTP_DCM_REP', '101');

insert into TOSCSTMMGR.TOS_APP_PARAMETER ( KEY, VALUE) values ( 'FTP_ID_N4', '000'); -- need to delete this
insert into TOSCSTMMGR.TOS_APP_PARAMETER ( KEY, VALUE) values ( 'FTP_ID_CMIS', '000'); -- need proxy ID from Eric
